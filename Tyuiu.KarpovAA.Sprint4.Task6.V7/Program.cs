...
namespace Tyuiu.KarpovAA.Sprint4.Task6.V7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* 'Биология', 'География', 'История', 'Экономика'] используя класс        *");
            Console.WriteLine("* Array подсчитайте количество элементов, длина которых больше 8.         *");
            Console.WriteLine("***************************************************************************");
            ...
            Console.WriteLine("Количество элементов, длина которых больше 8: " + result);
